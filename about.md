...
<div class="post" >
  ...
  <img src="{{ '/files/myphoto_.jpg' | relative_url }}" 
       alt="" 
       style="max-width:200px; border-radius:50%; margin-bottom:20px;">
  </div>

  <p class="intro" style="font-size:1.3rem;">
...
Two recent studies published in <em>Springer Nature</em> and <em>Cells</em> reflect this direction. In 
    ...
    <a href="https://www.mdpi.com/2073-4409/14/14/1115" target="_blank">the other</a>, I modeled metabolomic and proteomic profiles to define subtype-specific network modules in rhabdomyosarcoma.<br>
