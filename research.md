...
Despite the limitations of metabolite coverage, this integrated approach allowed us to pinpoint CRC-related modules, identify high-influence hub metabolites, and characterize network patterns that suggest promising biomarker candidates and mechanistic pathways.      
**Resources:** **[Paper Link](https://link.springer.com/article/10.1007/s00726-025-03448-3)** | **[Source Code](https://bits-and-bites.netlify.app/)**  </div>  


#### **[2. Integrative Multi-Omics Profiling of Rhabdomyosarcoma Subtypes Reveals Distinct Molecular Pathways and Biomarker Signatures]("https://www.mdpi.com/2073-4409/14/14/1115")**
...
This framework helped disentangle the high heterogeneity across subtypes, map the main altered pathways, and propose biologically plausible biomarkers grounded in network rather than single-gene signals.    
**Resources:** **[Paper Link]("https://www.mdpi.com/2073-4409/14/14/1115")** | **[Source Code]("https://github.com/Menna-Arafat/Rhabdomyosarcome_project")** </div>
...
I then constructed a network of experimentally supported miRNA–target interactions, prioritizing targets regulated by coordinated miRNA changes, and performed pathway enrichment analysis to delineate the molecular processes associated with each breast cancer subtype.    
**Resources:** **[Source Code]("https://github.com/Menna-Arafat/BC_EVs_miRNA")**</div>


#### **4. CrosstalkX: Mutual Information–Based Pathway Interaction Inference**

<div class="expandable">
Developed CrosstalkX, an R package that uses mutual information to detect nonlinear interactions among signaling pathways and prioritize core regulatory components. The method identifies pathway–pathway and pathway–TF interactions using biologically informed constraints and permutation testing for robust inference. It allows to quantify pathway–pathway and pathway–TF dependencies in complex omics data.
**Resources:** **[Source Code]("https://github.com/Menna-Arafat/CrosstalkX")** </div>

#### **5. A Multi-Omics and Mutual Information Framework to Decode Therapeutic Vulnerabilities in TNBC**
...
**Resources:** **[Source Code]("https://github.com/Menna-Arafat/GMSC_project")**</div>

#### **7.	Proteomic Profiling of Pancreatic Cancer Patients: Time Series Study Before and After Whipple Surgery**
...
**Resources:** **[Source Code]("https://github.com/Menna-Arafat/Whiple_surgery_project")** </div>
